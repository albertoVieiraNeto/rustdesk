...
!define PRODUCT_NAME "DeskViewer"
...
Name "${PRODUCT_NAME}"
Outfile "DeskViewer-${VERSION}-setup.exe"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "Publisher" "CosmosPro, Inc."
